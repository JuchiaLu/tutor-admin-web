<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column  label="教师资格证1" width="140" align="center">
      ...
      <el-table-column  label="教师资格证2" width="140" align="center">
        <template slot-scope="scope">
          <el-image
            style="width: 100px; height: 50px"
      ...
      <el-table-column  label="教师资格证3" width="140" align="center">
        <template slot-scope="scope">
          <el-image
            style="width: 100px; height: 50px"
      ...
      <el-table-column  label="教师资格证4" width="140" align="center">
        <template slot-scope="scope">
          <el-image
            style="width: 100px; height: 50px"
      ...
      <el-table-column  label="教师资格证5" width="140" align="center">
        <template slot-scope="scope">
          <el-image
            style="width: 100px; height: 50px"
...
<script>
  ...
  import * as teacherApi from '@/api/business/teacherAuth'
