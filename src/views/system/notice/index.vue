  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        noticeApi.page(this.listQuery).then(response => {
      ...
      handleDelete(index, row) {
        this.$confirm('此操作将永久删除, 是否继续?', '提示', {
          ...
          return noticeApi.deleteById(row.id)
        }).then(() => {
          this.$message({
            message: '删除成功',
            type: 'success',
      ...
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          noticeApi.save(this.tempForm).then(response => {
            return response
          }).then((response) => {
            this.$message({
              message: '添加成功',
      ...
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          noticeApi.patch(this.tempForm).then(respose => {
            return respose
          }).then((response) => {
            this.$message({
              message: '修改成功',
